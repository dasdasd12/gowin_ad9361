...
#
# Generated by export_simulation on Tue Oct 07 20:27:03 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_4.sh' script.

./clk_wiz_4.sh -reset_run
...
./clk_wiz_4.sh -noclean_files

For more information on the script, please type './clk_wiz_4.sh -help'.
