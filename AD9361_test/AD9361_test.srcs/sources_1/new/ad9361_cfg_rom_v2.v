module ad9361_cfg_rom_v2(
    ...
    always @(posedge clk) begin
        case(addr)
            ...
            12'd0038: data <= 20'h03D00; // SPIWrite [03D]=00, LVDS polarity invert
            12'd0039: data <= 20'h03E00; // SPIWrite [03E]=00, LVDS polarity invert
            // ************************************************************
            // Setup AuxDAC
            // ************************************************************
            ...
            // Setup Control Outs
            // ************************************************************
            12'd0056: data <= 20'h03500; // SPIWrite [035]=00, Ctrl Out index
            ...
            12'd0088: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RXCP,100	, Wait for CP cal to complete, Max RXCP Cal time: 460.800 (us)(Done when 0x244[7]==1)
            12'd0089: data <= 20'h27D04; // SPIWrite [27D]=04, Start TX CP cal
            12'd0090: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXCP,100	, Wait for CP cal to complete, Max TXCP Cal time: 460.800 (us)(Done when 0x284[7]==1)
            // ************************************************************
            ...
            // Setup Synthesizer
            // ************************************************************
            12'd0091: data <= 20'h23A4A; // SPIWrite [23A]=4A, Set VCO Output level[3:0]
            12'd0092: data <= 20'h239C3; // SPIWrite [239]=C3, Set Init ALC Value[3:0] and VCO Varactor[3:0]
            12'd0093: data <= 20'h2421F; // SPIWrite [242]=1F, Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
            12'd0094: data <= 20'h23878; // SPIWrite [238]=78, Set VCO Cal Offset[3:0]
            12'd0095: data <= 20'h24500; // SPIWrite [245]=00, Set VCO Cal Ref Tcf[2:0]
            12'd0096: data <= 20'h2510C; // SPIWrite [251]=0C, Set VCO Varactor Reference[3:0]
            12'd0097: data <= 20'h25070; // SPIWrite [250]=70, Set VCO Varactor Ref Tcf[2:0] and VCO Varactor Offset[3:0]
            12'd0098: data <= 20'h23B92; // SPIWrite [23B]=92, Set Synth Loop Filter charge pump current (Icp)
            12'd0099: data <= 20'h23ED4; // SPIWrite [23E]=D4, Set Synth Loop Filter C2 and C1
            12'd0100: data <= 20'h23FDF; // SPIWrite [23F]=DF, Set Synth Loop Filter  R1 and C3
            12'd0101: data <= 20'h24009; // SPIWrite [240]=09, Set Synth Loop Filter R3
            // ************************************************************
            // Setup Synthesizer
            // ************************************************************
            12'd0102: data <= 20'h27A4A; // SPIWrite [27A]=4A, Set VCO Output level[3:0]
            12'd0103: data <= 20'h279C1; // SPIWrite [279]=C1, Set Init ALC Value[3:0] and VCO Varactor[3:0]
            12'd0104: data <= 20'h28217; // SPIWrite [282]=17, Set VCO Bias Tcf[1:0] and VCO Bias Ref[2:0]
            12'd0105: data <= 20'h27878; // SPIWrite [278]=78, Set VCO Cal Offset[3:0]
            12'd0106: data <= 20'h28500; // SPIWrite [285]=00, Set VCO Cal Ref Tcf[2:0]
            12'd0107: data <= 20'h2910E; // SPIWrite [291]=0E, Set VCO Varactor Reference[3:0]
            12'd0108: data <= 20'h29070; // SPIWrite [290]=70, Set VCO Varactor Ref Tcf[2:0] and VCO Varactor Offset[3:0]
            12'd0109: data <= 20'h27B98; // SPIWrite [27B]=98, Set Synth Loop Filter charge pump current (Icp)
            12'd0110: data <= 20'h27ED4; // SPIWrite [27E]=D4, Set Synth Loop Filter C2 and C1
            12'd0111: data <= 20'h27FDF; // SPIWrite [27F]=DF, Set Synth Loop Filter  R1 and C3
            12'd0112: data <= 20'h28009; // SPIWrite [280]=09, Set Synth Loop Filter R3
            12'd0113: data <= 20'h23300; // SPIWrite [233]=00, Write Rx Synth Fractional Freq Word[7:0]
            12'd0114: data <= 20'h23400; // SPIWrite [234]=00, Write Rx Synth Fractional Freq Word[15:8]
            12'd0115: data <= 20'h23500; // SPIWrite [235]=00, Write Rx Synth Fractional Freq Word[22:16]
            12'd0116: data <= 20'h23200; // SPIWrite [232]=00, Write Rx Synth Integer Freq Word[10:8]
            12'd0117: data <= 20'h23150; // SPIWrite [231]=50, Write Rx Synth Integer Freq Word[7:0]
            12'd0118: data <= 20'h00522; // SPIWrite [005]=22, Set LO divider setting
            12'd0119: data <= 20'h27300; // SPIWrite [273]=00, Write Tx Synth Fractional Freq Word[7:0]
            ...
            12'd0917: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RXFILTER,2000	, Wait for RX filter to tune, Max Cal Time: 4.964 us (Done when 0x016[7]==0)
            12'd0918: data <= 20'h1E203; // SPIWrite [1E2]=03, Disable Rx Filter Tuner (Rx1)
            12'd0919: data <= 20'h1E303; // SPIWrite [1E3]=03, Disable Rx Filter Tuner (Rx2)
            // ************************************************************
            // TX Baseband Filter Tuning (Real BW: 10.000000 MHz) 3dB Filter
            // Corner @ 16.000000 MHz)
            // ************************************************************
            12'd0920: data <= 20'h0D607; // SPIWrite [0D6]=07, TX BBF Tune Divier[7:0]
            12'd0921: data <= 20'h0D71E; // SPIWrite [0D7]=1E, TX BBF Tune Divider[8]
            12'd0922: data <= 20'h0CA22; // SPIWrite [0CA]=22, Enable Tx Filter Tuner
            12'd0923: data <= 20'h01640; // SPIWrite [016]=40, Start Tx Filter Tune
            12'd0924: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXFILTER,2000	, Wait for TX filter to tune, Max Cal Time: 2.528 us (Done when 0x016[6]==0)
            12'd0925: data <= 20'h0CA26; // SPIWrite [0CA]=26, Disable Tx Filter Tuner (Both Channels)
            // ************************************************************
            // RX TIA Setup:  Setup values scale based on RxBBF calibration
            // results.  See information in Calibration Guide.
            // ************************************************************
            12'd0926: data <= 20'h1DB20; // SPIWrite [1DB]=20, Set TIA selcc[2:0]
            12'd0927: data <= 20'h1DD00; // SPIWrite [1DD]=00, Set RX TIA1 C MSB[6:0]
            12'd0928: data <= 20'h1DF00; // SPIWrite [1DF]=00, Set RX TIA2 C MSB[6:0]
            12'd0929: data <= 20'h1DC63; // SPIWrite [1DC]=63, Set RX TIA1 C LSB[5:0]
            12'd0930: data <= 20'h1DE63; // SPIWrite [1DE]=63, Set RX TIA2 C LSB[5:0]
            // ************************************************************
            // TX Secondary Filter Calibration Setup:  Real Bandwidth
            // 10.000000MHz, 3dB Corner @ 50.000000MHz
            // ************************************************************
            12'd0931: data <= 20'h0D214; // SPIWrite [0D2]=14, TX Secondary Filter PDF Cap cal[5:0]
            12'd0932: data <= 20'h0D10C; // SPIWrite [0D1]=0C, TX Secondary Filter PDF Res cal[3:0]
            12'd0933: data <= 20'h0D056; // SPIWrite [0D0]=56, Pdampbias
            // ************************************************************
            ...
            // ************************************************************
            12'd0934: data <= 20'h20000; // SPIWrite [200]=00
            12'd0935: data <= 20'h20100; // SPIWrite [201]=00
            12'd0936: data <= 20'h20200; // SPIWrite [202]=00
            12'd0937: data <= 20'h20324; // SPIWrite [203]=24
            12'd0938: data <= 20'h20424; // SPIWrite [204]=24
            12'd0939: data <= 20'h20500; // SPIWrite [205]=00
            12'd0940: data <= 20'h20600; // SPIWrite [206]=00
            12'd0941: data <= 20'h2077C; // SPIWrite [207]=7C
            12'd0942: data <= 20'h20854; // SPIWrite [208]=54
            12'd0943: data <= 20'h2093C; // SPIWrite [209]=3C
            12'd0944: data <= 20'h20A4B; // SPIWrite [20A]=4B
            12'd0945: data <= 20'h20B34; // SPIWrite [20B]=34
            12'd0946: data <= 20'h20C4E; // SPIWrite [20C]=4E
            12'd0947: data <= 20'h20D33; // SPIWrite [20D]=33
            12'd0948: data <= 20'h20E00; // SPIWrite [20E]=00
            12'd0949: data <= 20'h20F7F; // SPIWrite [20F]=7F
            12'd0950: data <= 20'h2107E; // SPIWrite [210]=7E
            12'd0951: data <= 20'h2117F; // SPIWrite [211]=7F
            12'd0952: data <= 20'h21249; // SPIWrite [212]=49
            12'd0953: data <= 20'h21348; // SPIWrite [213]=48
            12'd0954: data <= 20'h21449; // SPIWrite [214]=49
            12'd0955: data <= 20'h2154C; // SPIWrite [215]=4C
            12'd0956: data <= 20'h2164B; // SPIWrite [216]=4B
            12'd0957: data <= 20'h2174C; // SPIWrite [217]=4C
            12'd0958: data <= 20'h2182E; // SPIWrite [218]=2E
            12'd0959: data <= 20'h21998; // SPIWrite [219]=98
            12'd0960: data <= 20'h21A1B; // SPIWrite [21A]=1B
            12'd0961: data <= 20'h21B13; // SPIWrite [21B]=13
            12'd0962: data <= 20'h21C98; // SPIWrite [21C]=98
            12'd0963: data <= 20'h21D1B; // SPIWrite [21D]=1B
            12'd0964: data <= 20'h21E13; // SPIWrite [21E]=13
            12'd0965: data <= 20'h21F98; // SPIWrite [21F]=98
            12'd0966: data <= 20'h2201B; // SPIWrite [220]=1B
            12'd0967: data <= 20'h22127; // SPIWrite [221]=27
            12'd0968: data <= 20'h22227; // SPIWrite [222]=27
            12'd0969: data <= 20'h22340; // SPIWrite [223]=40
            12'd0970: data <= 20'h22440; // SPIWrite [224]=40
            12'd0971: data <= 20'h2252C; // SPIWrite [225]=2C
            12'd0972: data <= 20'h22600; // SPIWrite [226]=00
            12'd0973: data <= 20'h22700; // SPIWrite [227]=00
            // ************************************************************
            // Tx Quadrature Calibration Settings
            // ************************************************************
            12'd0974: data <= 20'h0A040; // SPIWrite [0A0]=40, Set TxQuadcal NCO frequency
            12'd0975: data <= 20'h0A380; // SPIWrite [0A3]=80, Set TxQuadcal NCO frequency (Only update bits [7:6])
            12'd0976: data <= 20'h0A17B; // SPIWrite [0A1]=7B, Set TxQuadcal M[1:0]
            12'd0977: data <= 20'h0A9FF; // SPIWrite [0A9]=FF, Set Tx Quad Cal Count
            12'd0978: data <= 20'h0A27F; // SPIWrite [0A2]=7F, Set Tx Quad Cal Kexp
            12'd0979: data <= 20'h0A501; // SPIWrite [0A5]=01, Set Tx Quad Cal Magnitude Threshhold
            12'd0980: data <= 20'h0A601; // SPIWrite [0A6]=01, Set Tx Quad Cal Magnitude Threshhold
            12'd0981: data <= 20'h0AA25; // SPIWrite [0AA]=25, Set Tx Quad Cal Gain Table index
            12'd0982: data <= 20'h0A4F0; // SPIWrite [0A4]=F0, Set Tx Quad Cal Setting Count
            12'd0983: data <= 20'h0AE00; // SPIWrite [0AE]=00, Set Tx Quad Cal LPF Gain index incase Split table mode used
            12'd0984: data <= 20'h1933F; // SPIWrite [193]=3F, BBDC Cal setting
            12'd0985: data <= 20'h1900F; // SPIWrite [190]=0F, Set BBDC tracking shift M value, only applies when BB DC tracking enabled
            12'd0986: data <= 20'h19401; // SPIWrite [194]=01, BBDC Cal setting
            12'd0987: data <= 20'h01601; // SPIWrite [016]=01, Start BBDC offset cal
            12'd0988: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	BBDC,2000	, BBDC Max Cal Time: 13151.042 us. Cal done when 0x016[0]==0
            12'd0989: data <= 20'h18520; // SPIWrite [185]=20, Set RF DC offset Wait Count
            12'd0990: data <= 20'h18632; // SPIWrite [186]=32, Set RF DC Offset Count[7:0]
            12'd0991: data <= 20'h18724; // SPIWrite [187]=24, Settings for RF DC cal
            12'd0992: data <= 20'h18B83; // SPIWrite [18B]=83, Settings for RF DC cal
            12'd0993: data <= 20'h18805; // SPIWrite [188]=05, Settings for RF DC cal
            12'd0994: data <= 20'h18930; // SPIWrite [189]=30, Settings for RF DC cal
            12'd0995: data <= 20'h01602; // SPIWrite [016]=02, RFDC Max Cal Time: 59923.828 us
            12'd0996: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RFDC,2000	, Wait for cal to complete (Done when 0x016[1]==0)
            12'd0997: data <= 20'h01610; // SPIWrite [016]=10, TXQuad Max Cal Time: 3075.000 us
            12'd0998: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXQUAD,2000	, Wait for cal to complete (Done when 0x016[4]==0)
            12'd0999: data <= 20'h16803; // SPIWrite [168]=03, Set RX Quadcal Tone Level
            12'd1000: data <= 20'h16E25; // SPIWrite [16E]=25, Set Rx Gain index to use during RX Quadcal
            12'd1001: data <= 20'h16A75; // SPIWrite [16A]=75, Set Kexp Phase
            12'd1002: data <= 20'h16B15; // SPIWrite [16B]=15, Set Kexp Amplitude
            12'd1003: data <= 20'h169CF; // SPIWrite [169]=CF
            12'd1004: data <= 20'h18BAD; // SPIWrite [18B]=AD
            12'd1005: data <= 20'h01210; // SPIWrite [012]=10, Cals done, Set PPORT Config
            12'd1006: data <= 20'h01301; // SPIWrite [013]=01, Set ENSM FDD/TDD bit
            12'd1007: data <= 20'h01584; // SPIWrite [015]=84, Set Dual Synth Mode, FDD External Control bits properly
            // ************************************************************
            // Set Tx Attenuation: Tx1: 10.00 dB,  Tx2: 10.00 dB
            // ************************************************************
            12'd1008: data <= 20'h07328; // SPIWrite [073]=28
            12'd1009: data <= 20'h07400; // SPIWrite [074]=00
            12'd1010: data <= 20'h07528; // SPIWrite [075]=28
            12'd1011: data <= 20'h07600; // SPIWrite [076]=00
            // ************************************************************
            // Setup RSSI and Power Measurement Duration Registers
            // ************************************************************
            12'd1012: data <= 20'h1500B; // SPIWrite [150]=0B, RSSI Measurement Duration 0, 1
            12'd1013: data <= 20'h15100; // SPIWrite [151]=00, RSSI Measurement Duration 2, 3
            12'd1014: data <= 20'h152FF; // SPIWrite [152]=FF, RSSI Weighted Multiplier 0
            12'd1015: data <= 20'h15300; // SPIWrite [153]=00, RSSI Weighted Multiplier 1
            12'd1016: data <= 20'h15400; // SPIWrite [154]=00, RSSI Weighted Multiplier 2
            12'd1017: data <= 20'h15500; // SPIWrite [155]=00, RSSI Weighted Multiplier 3
            12'd1018: data <= 20'h15600; // SPIWrite [156]=00, RSSI Delay
            12'd1019: data <= 20'h15700; // SPIWrite [157]=00, RSSI Wait
            12'd1020: data <= 20'h1580D; // SPIWrite [158]=0D, RSSI Mode Select
            12'd1021: data <= 20'h15C69; // SPIWrite [15C]=69, Power Measurement Duration
            12'd1022: data <= 20'h0025C; // SPIWrite [002]=5C, Set # transmitters enabled
            12'd1023: data <= 20'h0035C; // SPIWrite [003]=5C, Set # receivers enabled

            12'd1024: data <= 20'h09F01;
            12'd1025: data <= 20'h08E00;
            12'd1026: data <= 20'h08F00;

            12'd1027: data <= 20'h01407; // SPIWrite [014]=07, State Machine Set
            12'd1028: data <= 20'h01423; // SPIWrite [014]=23, State Machine Set
            12'd1029: data <= 20'h80000; // INIT_END
            default:
                data <= 20'h00000;
        endcase
    end
