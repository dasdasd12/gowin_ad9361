module ad9361_cfg_rom_v7(
    ...
    always @(posedge clk) begin
        case(addr)
            ...
            // Evaluation Software\DigitalFilters\AD9361_16M_FIR.ftr
            // ************************************************************
            ...
            12'd1666: data <= 20'h27155; // SPIWrite [271]=55, Write Tx Synth Integer Freq Word[7:0] (starts VCO cal)
            ...
            12'd2432: data <= 20'h100AF; // SPIWrite [100]=AF, Max Digital Gain
            ...
            12'd2440: data <= 20'h11105; // SPIWrite [111]=05, Settling Delay
            ...
            12'd2446: data <= 20'h124FA; // SPIWrite [124]=FA, Gain Update Counter<7:0>
            12'd2447: data <= 20'h1250E; // SPIWrite [125]=0E, Gain Update Counter<15:8>
            ...
            // ************************************************************
            12'd2451: data <= 20'h1FB08; // SPIWrite [1FB]=08, RX Freq Corner (MHz)
            12'd2452: data <= 20'h1FC00; // SPIWrite [1FC]=00, RX Freq Corner (Khz)
            12'd2453: data <= 20'h1F808; // SPIWrite [1F8]=08, Rx BBF Tune Divider[7:0]
            ...
            12'd2460: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RXFILTER,2000	, Wait for RX filter to tune, Max Cal Time: 6.619 us (Done when 0x016[7]==0)
            ...
            // ************************************************************
            12'd2463: data <= 20'h0D607; // SPIWrite [0D6]=07, TX BBF Tune Divier[7:0]
            ...
            12'd2467: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXFILTER,2000	, Wait for TX filter to tune, Max Cal Time: 3.370 us (Done when 0x016[6]==0)
            ...
            // ************************************************************
            12'd2469: data <= 20'h1DB60; // SPIWrite [1DB]=60, Set TIA selcc[2:0]
            ...
            12'd2472: data <= 20'h1DC6E; // SPIWrite [1DC]=6E, Set RX TIA1 C LSB[5:0]
            12'd2473: data <= 20'h1DE6E; // SPIWrite [1DE]=6E, Set RX TIA2 C LSB[5:0]
            // ************************************************************
            // TX Secondary Filter Calibration Setup:  Real Bandwidth
            // 8.000000MHz, 3dB Corner @ 40.000000MHz
            // ************************************************************
            12'd2474: data <= 20'h0D21C; // SPIWrite [0D2]=1C, TX Secondary Filter PDF Cap cal[5:0]
            12'd2475: data <= 20'h0D10C; // SPIWrite [0D1]=0C, TX Secondary Filter PDF Res cal[3:0]
            12'd2476: data <= 20'h0D056; // SPIWrite [0D0]=56, Pdampbias
            // ************************************************************
            ...
            12'd2484: data <= 20'h2077B; // SPIWrite [207]=7B
            12'd2485: data <= 20'h20838; // SPIWrite [208]=38
            12'd2486: data <= 20'h2093B; // SPIWrite [209]=3B
            12'd2487: data <= 20'h20A4A; // SPIWrite [20A]=4A
            12'd2488: data <= 20'h20B23; // SPIWrite [20B]=23
            12'd2489: data <= 20'h20C4D; // SPIWrite [20C]=4D
            12'd2490: data <= 20'h20D21; // SPIWrite [20D]=21
            12'd2491: data <= 20'h20E00; // SPIWrite [20E]=00
            12'd2492: data <= 20'h20F7E; // SPIWrite [20F]=7E
            12'd2493: data <= 20'h2107D; // SPIWrite [210]=7D
            12'd2494: data <= 20'h2117E; // SPIWrite [211]=7E
            12'd2495: data <= 20'h21248; // SPIWrite [212]=48
            12'd2496: data <= 20'h21347; // SPIWrite [213]=47
            12'd2497: data <= 20'h21448; // SPIWrite [214]=48
            12'd2498: data <= 20'h2154B; // SPIWrite [215]=4B
            12'd2499: data <= 20'h2164A; // SPIWrite [216]=4A
            12'd2500: data <= 20'h2174B; // SPIWrite [217]=4B
            ...
            // ************************************************************
            12'd2517: data <= 20'h0A015; // SPIWrite [0A0]=15, Set TxQuadcal NCO frequency
            12'd2518: data <= 20'h0A300; // SPIWrite [0A3]=00, Set TxQuadcal NCO frequency (Only update bits [7:6])
            ...
            12'd2564: data <= 20'h15C66; // SPIWrite [15C]=66, Power Measurement Duration
