module ad9361_cfg_rom_v6(
    ...
    always @(posedge clk) begin
        case(addr)
            ...
            12'd0009: data <= 20'h00907; // SPIWrite [009]=17, Enable Clocks
            ...
            // ************************************************************
            12'd2427: data <= 20'h0220A; // SPIWrite [022]=0A, AGC Fast Attack Gain Lock Delay
            12'd2428: data <= 20'h0FAE5; // SPIWrite [0FA]=E5, Gain Control Mode Select
            12'd2429: data <= 20'h0FB08; // SPIWrite [0FB]=08, Gain Control Config
            12'd2430: data <= 20'h0FC03; // SPIWrite [0FC]=03, ADC Overrange Sample Size
            12'd2431: data <= 20'h0FD4C; // SPIWrite [0FD]=4C, Max Full/LMT Gain Table Index
            12'd2432: data <= 20'h0FE44; // SPIWrite [0FE]=44, Peak Overload Wait Time
            12'd2433: data <= 20'h1006F; // SPIWrite [100]=6F, Dig Gain: Step Size & Max
            12'd2434: data <= 20'h1010A; // SPIWrite [101]=0A, AGC Lock Level
            12'd2435: data <= 20'h10308; // SPIWrite [103]=08, Large LMT or Step 3 Size
            12'd2436: data <= 20'h1042F; // SPIWrite [104]=2F, ADC Small Overload Threshold
            12'd2437: data <= 20'h1053A; // SPIWrite [105]=3A, ADC Large Overload Threshold
            12'd2438: data <= 20'h10645; // SPIWrite [106]=45, Overload Step Sizes
            12'd2439: data <= 20'h10731; // SPIWrite [107]=31, Small LMT Overload Threshold
            12'd2440: data <= 20'h10839; // SPIWrite [108]=39, Large LMT Overload Threshold
            12'd2441: data <= 20'h1094C; // SPIWrite [109]=4C, State 5 Power Measurement MSB
            12'd2442: data <= 20'h10A58; // SPIWrite [10A]=58, State 5 Power Measurement LSBs
            12'd2443: data <= 20'h10B00; // SPIWrite [10B]=00, Rx1 Force Digital Gain
            12'd2444: data <= 20'h10E00; // SPIWrite [10E]=00, Rx2 Force Digital Gain
            12'd2445: data <= 20'h11000; // SPIWrite [110]=00, AGC Fast Attack Config
            12'd2446: data <= 20'h1114A; // SPIWrite [111]=4A, Settling Delay & AGC Config
            12'd2447: data <= 20'h1124A; // SPIWrite [112]=4A, Post Lock Step & Energy Lost Thresh
            12'd2448: data <= 20'h1134A; // SPIWrite [113]=4A, Post Lock Step & Strong Sig Thresh
            12'd2449: data <= 20'h11430; // SPIWrite [114]=30, Low Power Threshold & ADC Ovr Ld
            12'd2450: data <= 20'h11500; // SPIWrite [115]=00, Stronger Signal Unlock Control
            12'd2451: data <= 20'h11665; // SPIWrite [116]=65, Final Overrange and Opt Gain Offset
            12'd2452: data <= 20'h11708; // SPIWrite [117]=08, Gain Inc Step & Energy Detect Cnt
            12'd2453: data <= 20'h11805; // SPIWrite [118]=05, Lock Level GAin Incr Upper Limit
            12'd2454: data <= 20'h11908; // SPIWrite [119]=08, Gain Lock Exit Count
            12'd2455: data <= 20'h11A27; // SPIWrite [11A]=27, Initial LMT Gain Limit
            12'd2456: data <= 20'h11B0A; // SPIWrite [11B]=0A, Increment Time
            // ************************************************************
            // RX Baseband Filter Tuning (Real BW: 8.000000 MHz) 3dB Filter
            // Corner @ 11.200000 MHz)
            // ************************************************************
            12'd2457: data <= 20'h1FB08; // SPIWrite [1FB]=08, RX Freq Corner (MHz)
            12'd2458: data <= 20'h1FC00; // SPIWrite [1FC]=00, RX Freq Corner (Khz)
            12'd2459: data <= 20'h1F808; // SPIWrite [1F8]=08, Rx BBF Tune Divider[7:0]
            12'd2460: data <= 20'h1F91E; // SPIWrite [1F9]=1E, RX BBF Tune Divider[8]
            12'd2461: data <= 20'h1D53F; // SPIWrite [1D5]=3F, Set Rx Mix LO CM
            12'd2462: data <= 20'h1C003; // SPIWrite [1C0]=03, Set GM common mode
            12'd2463: data <= 20'h1E202; // SPIWrite [1E2]=02, Enable Rx1 Filter Tuner
            12'd2464: data <= 20'h1E302; // SPIWrite [1E3]=02, Enable Rx2 Filter Tuner
            12'd2465: data <= 20'h01680; // SPIWrite [016]=80, Start RX Filter Tune
            12'd2466: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RXFILTER,2000	, Wait for RX filter to tune, Max Cal Time: 6.619 us (Done when 0x016[7]==0)
            12'd2467: data <= 20'h1E203; // SPIWrite [1E2]=03, Disable Rx Filter Tuner (Rx1)
            12'd2468: data <= 20'h1E303; // SPIWrite [1E3]=03, Disable Rx Filter Tuner (Rx2)
            // ************************************************************
            // TX Baseband Filter Tuning (Real BW: 8.000000 MHz) 3dB Filter
            // Corner @ 12.800000 MHz)
            // ************************************************************
            12'd2469: data <= 20'h0D607; // SPIWrite [0D6]=07, TX BBF Tune Divier[7:0]
            12'd2470: data <= 20'h0D71E; // SPIWrite [0D7]=1E, TX BBF Tune Divider[8]
            12'd2471: data <= 20'h0CA22; // SPIWrite [0CA]=22, Enable Tx Filter Tuner
            12'd2472: data <= 20'h01640; // SPIWrite [016]=40, Start Tx Filter Tune
            12'd2473: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXFILTER,2000	, Wait for TX filter to tune, Max Cal Time: 3.370 us (Done when 0x016[6]==0)
            12'd2474: data <= 20'h0CA26; // SPIWrite [0CA]=26, Disable Tx Filter Tuner (Both Channels)
            // ************************************************************
            // RX TIA Setup:  Setup values scale based on RxBBF calibration
            // results.  See information in Calibration Guide.
            // ************************************************************
            12'd2475: data <= 20'h1DB60; // SPIWrite [1DB]=60, Set TIA selcc[2:0]
            12'd2476: data <= 20'h1DD00; // SPIWrite [1DD]=00, Set RX TIA1 C MSB[6:0]
            12'd2477: data <= 20'h1DF00; // SPIWrite [1DF]=00, Set RX TIA2 C MSB[6:0]
            12'd2478: data <= 20'h1DC6E; // SPIWrite [1DC]=6E, Set RX TIA1 C LSB[5:0]
            12'd2479: data <= 20'h1DE6E; // SPIWrite [1DE]=6E, Set RX TIA2 C LSB[5:0]
            // ************************************************************
            // TX Secondary Filter Calibration Setup:  Real Bandwidth
            // 8.000000MHz, 3dB Corner @ 40.000000MHz
            // ************************************************************
            12'd2480: data <= 20'h0D21C; // SPIWrite [0D2]=1C, TX Secondary Filter PDF Cap cal[5:0]
            12'd2481: data <= 20'h0D10C; // SPIWrite [0D1]=0C, TX Secondary Filter PDF Res cal[3:0]
            12'd2482: data <= 20'h0D056; // SPIWrite [0D0]=56, Pdampbias
            // ************************************************************
            // ADC Setup:  Tune ADC Performance based on RX analog filter tune
            // corner.  Real Bandwidth: 7.262063 MHz, ADC Clock Frequency:
            // 368.640000 MHz.  The values in registers 0x200 - 0x227 need to be
            // calculated using the equations in the Calibration Guide.
            // ************************************************************
            12'd2483: data <= 20'h20000; // SPIWrite [200]=00
            12'd2484: data <= 20'h20100; // SPIWrite [201]=00
            12'd2485: data <= 20'h20200; // SPIWrite [202]=00
            12'd2486: data <= 20'h20324; // SPIWrite [203]=24
            12'd2487: data <= 20'h20424; // SPIWrite [204]=24
            12'd2488: data <= 20'h20500; // SPIWrite [205]=00
            12'd2489: data <= 20'h20600; // SPIWrite [206]=00
            12'd2490: data <= 20'h2077B; // SPIWrite [207]=7B
            12'd2491: data <= 20'h20838; // SPIWrite [208]=38
            12'd2492: data <= 20'h2093B; // SPIWrite [209]=3B
            12'd2493: data <= 20'h20A4A; // SPIWrite [20A]=4A
            12'd2494: data <= 20'h20B23; // SPIWrite [20B]=23
            12'd2495: data <= 20'h20C4D; // SPIWrite [20C]=4D
            12'd2496: data <= 20'h20D21; // SPIWrite [20D]=21
            12'd2497: data <= 20'h20E00; // SPIWrite [20E]=00
            12'd2498: data <= 20'h20F7E; // SPIWrite [20F]=7E
            12'd2499: data <= 20'h2107D; // SPIWrite [210]=7D
            12'd2500: data <= 20'h2117E; // SPIWrite [211]=7E
            12'd2501: data <= 20'h21248; // SPIWrite [212]=48
            12'd2502: data <= 20'h21347; // SPIWrite [213]=47
            12'd2503: data <= 20'h21448; // SPIWrite [214]=48
            12'd2504: data <= 20'h2154B; // SPIWrite [215]=4B
            12'd2505: data <= 20'h2164A; // SPIWrite [216]=4A
            12'd2506: data <= 20'h2174B; // SPIWrite [217]=4B
            12'd2507: data <= 20'h2182E; // SPIWrite [218]=2E
            12'd2508: data <= 20'h219A4; // SPIWrite [219]=A4
            12'd2509: data <= 20'h21A26; // SPIWrite [21A]=26
            12'd2510: data <= 20'h21B18; // SPIWrite [21B]=18
            12'd2511: data <= 20'h21CA4; // SPIWrite [21C]=A4
            12'd2512: data <= 20'h21D26; // SPIWrite [21D]=26
            12'd2513: data <= 20'h21E18; // SPIWrite [21E]=18
            12'd2514: data <= 20'h21FA4; // SPIWrite [21F]=A4
            12'd2515: data <= 20'h22026; // SPIWrite [220]=26
            12'd2516: data <= 20'h2212F; // SPIWrite [221]=2F
            12'd2517: data <= 20'h22230; // SPIWrite [222]=30
            12'd2518: data <= 20'h22340; // SPIWrite [223]=40
            12'd2519: data <= 20'h22440; // SPIWrite [224]=40
            12'd2520: data <= 20'h2252C; // SPIWrite [225]=2C
            12'd2521: data <= 20'h22600; // SPIWrite [226]=00
            12'd2522: data <= 20'h22700; // SPIWrite [227]=00
            // ************************************************************
            // Tx Quadrature Calibration Settings
            // ************************************************************
            12'd2523: data <= 20'h0A015; // SPIWrite [0A0]=15, Set TxQuadcal NCO frequency
            12'd2524: data <= 20'h0A300; // SPIWrite [0A3]=00, Set TxQuadcal NCO frequency (Only update bits [7:6])
            12'd2525: data <= 20'h0A17B; // SPIWrite [0A1]=7B, Set TxQuadcal M[1:0]
            12'd2526: data <= 20'h0A9FF; // SPIWrite [0A9]=FF, Set Tx Quad Cal Count
            12'd2527: data <= 20'h0A27F; // SPIWrite [0A2]=7F, Set Tx Quad Cal Kexp
            12'd2528: data <= 20'h0A501; // SPIWrite [0A5]=01, Set Tx Quad Cal Magnitude Threshhold
            12'd2529: data <= 20'h0A601; // SPIWrite [0A6]=01, Set Tx Quad Cal Magnitude Threshhold
            12'd2530: data <= 20'h0AA25; // SPIWrite [0AA]=25, Set Tx Quad Cal Gain Table index
            12'd2531: data <= 20'h0A4F0; // SPIWrite [0A4]=F0, Set Tx Quad Cal Setting Count
            12'd2532: data <= 20'h0AE00; // SPIWrite [0AE]=00, Set Tx Quad Cal LPF Gain index incase Split table mode used
            12'd2533: data <= 20'h1933F; // SPIWrite [193]=3F, BBDC Cal setting
            12'd2534: data <= 20'h1900F; // SPIWrite [190]=0F, Set BBDC tracking shift M value, only applies when BB DC tracking enabled
            12'd2535: data <= 20'h19401; // SPIWrite [194]=01, BBDC Cal setting
            12'd2536: data <= 20'h01601; // SPIWrite [016]=01, Start BBDC offset cal
            12'd2537: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	BBDC,2000	, BBDC Max Cal Time: 3287.760 us. Cal done when 0x016[0]==0
            12'd2538: data <= 20'h18520; // SPIWrite [185]=20, Set RF DC offset Wait Count
            12'd2539: data <= 20'h18632; // SPIWrite [186]=32, Set RF DC Offset Count[7:0]
            12'd2540: data <= 20'h18724; // SPIWrite [187]=24, Settings for RF DC cal
            12'd2541: data <= 20'h18B83; // SPIWrite [18B]=83, Settings for RF DC cal
            12'd2542: data <= 20'h18805; // SPIWrite [188]=05, Settings for RF DC cal
            12'd2543: data <= 20'h18930; // SPIWrite [189]=30, Settings for RF DC cal
            12'd2544: data <= 20'h01602; // SPIWrite [016]=02, RFDC Max Cal Time: 14980.957 us
            12'd2545: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	RFDC,2000	, Wait for cal to complete (Done when 0x016[1]==0)
            12'd2546: data <= 20'h01610; // SPIWrite [016]=10, TXQuad Max Cal Time: 1537.500 us
            12'd2547: data <= 20'h40000; // WAIT 20 ms, WAIT_CALDONE	TXQUAD,2000	, Wait for cal to complete (Done when 0x016[4]==0)
            12'd2548: data <= 20'h16803; // SPIWrite [168]=03, Set RX Quadcal Tone Level
            12'd2549: data <= 20'h16E25; // SPIWrite [16E]=25, Set Rx Gain index to use during RX Quadcal
            12'd2550: data <= 20'h16A75; // SPIWrite [16A]=75, Set Kexp Phase
            12'd2551: data <= 20'h16B15; // SPIWrite [16B]=15, Set Kexp Amplitude
            12'd2552: data <= 20'h169CF; // SPIWrite [169]=CF
            12'd2553: data <= 20'h18BAD; // SPIWrite [18B]=AD
            12'd2554: data <= 20'h01210; // SPIWrite [012]=10, Cals done, Set PPORT Config
            12'd2555: data <= 20'h01301; // SPIWrite [013]=01, Set ENSM FDD/TDD bit
            12'd2556: data <= 20'h01584; // SPIWrite [015]=84, Set Dual Synth Mode, FDD External Control bits properly
            // ************************************************************
            // Set Tx Attenuation: Tx1: 10.00 dB,  Tx2: 10.00 dB
            // ************************************************************
            12'd2557: data <= 20'h07328; // SPIWrite [073]=28
            12'd2558: data <= 20'h07400; // SPIWrite [074]=00
            12'd2559: data <= 20'h07528; // SPIWrite [075]=28
            12'd2560: data <= 20'h07600; // SPIWrite [076]=00
            // ************************************************************
            // Setup RSSI and Power Measurement Duration Registers
            // ************************************************************
            12'd2561: data <= 20'h15008; // SPIWrite [150]=08, RSSI Measurement Duration 0, 1
            12'd2562: data <= 20'h15100; // SPIWrite [151]=00, RSSI Measurement Duration 2, 3
            12'd2563: data <= 20'h152FF; // SPIWrite [152]=FF, RSSI Weighted Multiplier 0
            12'd2564: data <= 20'h15300; // SPIWrite [153]=00, RSSI Weighted Multiplier 1
            12'd2565: data <= 20'h15400; // SPIWrite [154]=00, RSSI Weighted Multiplier 2
            12'd2566: data <= 20'h15500; // SPIWrite [155]=00, RSSI Weighted Multiplier 3
            12'd2567: data <= 20'h15600; // SPIWrite [156]=00, RSSI Delay
            12'd2568: data <= 20'h15700; // SPIWrite [157]=00, RSSI Wait
            12'd2569: data <= 20'h15801; // SPIWrite [158]=01, RSSI Mode Select
            12'd2570: data <= 20'h15C62; // SPIWrite [15C]=62, Power Measurement Duration
            12'd2571: data <= 20'h00261; // SPIWrite [002]=61, Set # transmitters enabled
            12'd2572: data <= 20'h00362; // SPIWrite [003]=62, Set # receivers enabled

            //TX IQ Qualization 
            12'd2573: data <= 20'h09F01;
            12'd2574: data <= 20'h08E00;
            12'd2575: data <= 20'h08F00;
            //RX IQ Qualization
            12'd2576: data <= 20'h18201;
            12'd2577: data <= 20'h17000;
            12'd2578: data <= 20'h17100;

            12'd2579: data <= 20'h01407; // SPIWrite [014]=07, State Machine Set
            12'd2580: data <= 20'h01423; // SPIWrite [014]=23, State Machine Set
            12'd2581: data <= 20'h80000; // INIT_END
            default:
                data <= 20'h00000;
        endcase
    end
